...
the output alignment of a tool as input and outputs the senstivity 
...
parser.add_argument("--pfam_clan_info", default="./data/pfam_clan_info.tsv", type=str, help= "The path to the file relating pfam to clan")
...
if not args.output:
    args.output = "./data/first_label_occ/" + os.path.basename(args.input)
