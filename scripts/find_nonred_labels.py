...
selected = []
for chunk in label_pf_clan_chunk(input_path=args.input, clan_info_path=args.clan_info_path, 
                                 remove_cif_ext=args.remove_cif_ext, remove_self_matches=True, 
                                 chunksize=args.chunksize, search_tool=args.search_tool):
